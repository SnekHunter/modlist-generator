...
class TestModInfo:
    ...
    def test_mod_info_immutable(self):
        ...
        mod = ModInfo(
            name="Test", loader="fabric", version="1.0.0", filename="test.jar"
        )
...
class TestScanResult:
    ...
    def test_create_scan_result(self):
        ...
        result = ScanResult(mods=mods, total_files=2, scan_duration=1.5, errors=[])
    ...
    def test_filter_by_loader(self):
        ...
        result = ScanResult(mods=mods, total_files=3, scan_duration=1.0, errors=[])
        filtered = result.filter_by_loader("fabric")

        assert len(filtered) == 2
        assert all(m.loader == "fabric" for m in filtered)
    ...
    def test_to_dict(self):
        ...
        result = ScanResult(
            mods=mods, total_files=1, scan_duration=1.5, errors=["Error 1"]
        )
